...
def product_reduce(squence, default=0):
...
class MultiRange:
    ...
    def __init__(self, *args):
        self.ranges = [arg_to_range(arg) for arg in args]
        self.generator = _generator(self.ranges)

    def __len__(self):
        return product_reduce(lens(self.ranges))
    ...
    def __getitem__(self, item):
        ...
        divisors = [product_reduce(_lens[i + 1::]) for i, _ in enumerate(_lens[:-1:])]
